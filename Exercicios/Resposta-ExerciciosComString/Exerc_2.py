...
# nome do usuário de trás para frente utilizando somente letras maiúsculas. Dica: lembre−se que ao informar o nome o usuário
...
print(f'O seu nome inverso é: {nome_inverso}')
